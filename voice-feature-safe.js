...
(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .voice-control { border: 0; border-radius: 12px; width: 38px; height: 38px; cursor: pointer; background: var(--tool-tag-bg, #e8f2ff); color: var(--ink, #0b5cab); font-size: 12px; font-weight: 700; }
      ...
      .voice-language { border: 1px solid var(--line, #d1d5db); border-radius: 8px; cursor: pointer; height: 28px; padding: 0 5px; background: var(--panel, #fff); color: var(--ink, #111827); font-size: 11px; font-weight: 700; }
      .voice-speak { border: 1px solid var(--line, #d1d5db); border-radius: 7px; background: var(--tool-tag-bg, #f1efe8); cursor: pointer; font-size: 11px; padding: 3px 6px; margin-left: 6px; color: var(--ink, #0b5cab); }
      #voice-status { position: absolute; right: 0; bottom: 42px; width: 230px; font-size: 12px; min-height: 16px; color: var(--ink-soft, #4b5563); background: var(--panel, #fff); border-radius: 6px; text-align: right; }
  ...
  function setupMicrophone() {
    ...
    languageButton.addEventListener("click", () => {
      ...
      languageButton.textContent = recognitionLanguage === "hi-IN" ? "HI" : "EN";
